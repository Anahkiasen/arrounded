...
use Arrounded\Localization\Exceptions\ExtractionException;
...
class Extractor extends AbstractService
{
	...
	{
		$directory  = $this->app['i18n.localizer']->getLocaleFolder($locale);
		$translated = $directory.'/' .$this->app['i18n.localizer']->getDomain(). '.po';
	...
	public function setHeaders($file, $locale)
	{
		...
		$contents = strtr($contents, array(
			'charset=CHARSET'                     => 'charset='.$this->app['i18n.localizer']->getEncoding(),
	...
	{
		// Build arguments
		$domain    = $this->app['i18n.localizer']->getDomain();
